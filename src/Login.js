  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://pizza-app-server.vercel.app/api/signup",
        formData
      );
  ...
  return (
    <div className="LoginWrop-container">
      <img
        ...
        alt="pizzaimg"
      ></img>
      <form className="login-cantaine-wrap" onSubmit={handleSubmit}>
        <h2 className="header-page">User Login</h2>
        <p className="para">Please Enter your Email and Password</p>
...
//       <br></br>
//       {alert && <div className="alertlogin">{alert}</div>}
//       <img
